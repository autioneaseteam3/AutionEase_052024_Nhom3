...
function ListAuctionRequestPage() {
  const defaultItem = {
    Id: "#1234",
    Name: "Car",
    NameSuplier: "John",
      ...
      <main>
        <div class="pt-6 px-4">
          <div className="w-full flex flex-col items-start">
            <span className=" text-black text-[24px] font-bold">Requests</span>
          ...
          <div className="flex justify-end mx-auto">
            ...
            >
              <option className=" bg-white text-black">State</option>
...
export default ListAuctionRequestPage;
