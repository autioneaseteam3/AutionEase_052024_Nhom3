...
function ListAuctionPage() {
  const defaultItem = {
    Id: "1234",
    Name: "Car",
    Autiontype: "20/03/2003",
    Events: "Thanksgiving/None",
    Status: "Active",
  };
  const data = Array.from({ length: 8 },()=>({...defaultItem})); 
  const column = ["Id", "Name", "Autiontype", "Events","Status", "Action"]; 
  return (
    <div
      id="content"
      ...
      <main>
        <div class="pt-6 px-4">
          <div className="w-full flex flex-col items-start">
            <span className=" text-black text-[24px] font-bold">Auctions</span>
          ...
          <div className="flex justify-end mx-auto">
            ...
            >
              <option className=" bg-white text-black">Events</option>
            ...
            <select
              ...
              data-ripple-light="false"
            >
              <option className=" bg-white text-black">Auction type</option>
              <option className=" bg-white text-black">Status</option>
              <option className=" bg-white text-black">Status</option>
            </select>
            <button
