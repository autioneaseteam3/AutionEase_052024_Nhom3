...
const Register = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white px-6 py-10 md:px-28 rounded-lg relative">
        ...
        <h2 className="text-2xl md:text-4xl mb-4">Welcome</h2>
        <form className="w-full flex flex-col justify-center items-center gap-2">
          <input
            type="text"
            className="block w-full md:w-[130%] p-3 mb-4 border rounded-2xl duration-300 ease-in-out transform focus:-translate-y-1 hover:border-[#ff4949] hover:shadow-lg focus:outline-[#ff4949]"
            required
            placeholder="Name"
          />
          <input
