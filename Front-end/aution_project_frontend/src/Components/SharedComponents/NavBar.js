...
function NavBar() {
  ...
  return (
    <nav
      id="header"
      class="w-full z-30 py-1 bg-[#ff4949] h-[120px] shadow-lg border-b border-blue-400 flex items-center"
    >
        ...
        >
          ...
          <nav>
            <ul class="md:flex items-center justify-between text-base text-blue-600 pt-4 md:pt-0">
              <li>
                <a
                  class="inline-block no-underline hover:text-black font-medium text-lg py-2 px-[40px] lg:-ml-2 text-white"
                  href="/"
                >
                  Home
                </a>
            ...
            {user === false ? (
              ...
              <>
                <button
                  ...
                  className="bg-transparent text-[#ff6767] rounded-md  p-2 px-5 border border-gray-300 mr-4 bg-gray-100 "
                >
                  Sign in
                </button>
                <button
                  onClick={() => setRegisterOpen(true)}
                  className="text-white rounded-md p-2 px-5 mr-4 bg-[#ff6767]"
                >
                  Sign up
                </button>
              </>
